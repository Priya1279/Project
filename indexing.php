					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">About Journal</a>
                                ...
                                <a class="dropdown-item" href="why.php" id="drop_items1">Why Choose Journal</a>
    ...
    <!-- /Secondary Navigation --> 
        ...
        <div class="col-md-9 col-sm-8 right-panel">
          <div class="box-default3"> 
           ...
           <h4 class="panel-title big">Indexing</h4>
</div>
<hr>
        ...
        <div class="row">
          <div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx4.png" class="img-thumbnail">  </a>
</div>
<div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx1.png" class="img-thumbnail"> </a> 
</div>
    </div>
		<hr>
<div class="row">
          <div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx2.png" class="img-thumbnail">  </a>
</div>
<div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx3.png" class="img-thumbnail"> </a> 
</div>
    </div>
<hr>
<div class="row">
          <div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx6.png" class="img-thumbnail">  </a>
</div>
<div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx5.png" class="img-thumbnail"> </a> 
</div>
    </div>
		<hr>
<div class="row">
          <div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx7.png" class="img-thumbnail">  </a>
</div>
<div class="col-md-6">
         <a href="" target="_blank"><img src="image/indx8.png" class="img-thumbnail"> </a> 
</div>
    </div>
<hr>
