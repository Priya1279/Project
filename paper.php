	...
	<div class="container">
			...
			<div id="breadcrumbs">
				<div class="container">
					...
					<a href="index.php">HOME</a>&nbsp;<b class="text-white">></b>
					<span class="divider"><i class="icon-arrow-right icons"></i></span>
					<a>CALL FOR PAPER</a>
				</div>
			</div>
...
<!-- /Secondary Navigation --> 
        ...
        <div class="col-md-9 col-sm-8 right-panel">
          <div class="box-default3"> 
           ...
           <h4 class="panel-title big">Call for Paper</h4>
</div>
<hr>
        ...
        <div class="row">
		<div class="col-md-12">
        <h5 class="text-info">Important Dates for Upcoming Issues:</h5>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="150">
  <tbody><tr class="alert alert-danger" style="font-size:14px; text-align:center">
    <td><strong>Submission last date </strong></td>
    <td> <strong>15  April 2023</strong></td>
  </tr>
   <tr class="alert alert-warning" style="font-size:14px; text-align:center">
    <td><strong>Acknowledgement of submission</strong></td>
    <td><strong>Within 24 hrs</strong></td>
  </tr>
    <tr class="alert alert-success" style="font-size:14px; text-align:center">
    <td><strong>Acceptance notification</strong></td>
    <td><strong>After 10 Days of submission (Blind peer review process) </strong></td>
  </tr>
    <tr class="alert alert-info" style="font-size:14px; text-align:center">
    <td><strong>Publication Date </strong></td>
    <td><strong>25  April 2022</strong></td>
  </tr>
        ...
        <section id="featured-list">
					<div id="myfeature-list">
                    <h3 style="text-align:left; font-size:20px;">Publication Process : </h3>
					<div class="scrolling">
							<ul class="clearfix">
            ...
            <p>&nbsp;</p>
        <a href="login.php"><img src="image/Untitled.png" class="img-thumbnail"></a>
