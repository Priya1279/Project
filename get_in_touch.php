					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">About Journal</a>
                                ...
                                <a class="dropdown-item" href="#" id="drop_items1">Journal Indexing</a>
                                            
                                <a class="dropdown-item" href="#" id="drop_items1">Why Choose IIS Journal</a>
                                            
                                <a class="dropdown-item" href="#" id="drop_items1">Call for Paper </a>
                                            
                                <a class="dropdown-item" href="#" id="drop_items1">Review Process</a>
                        ...
                        <li class="nav-item active dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">For Author </a>
                                <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" id="drop_items1">How to Submit Your Paper</a>
                                            
                                <a class="dropdown-item" href="#" id="drop_items1">How to pay publication fees</a>
                                            
                                <a class="dropdown-item" href="#" id="drop_items1">Manuscript Preprartion Guidelines</a>
	...
	<div class="container">
			...
			<div id="breadcrumbs">
				<div class="container">
					...
					<a href="index.html">IOSR Journal</a>&nbsp;<b class="text-white">></b>
					<span class="divider"><i class="icon-arrow-right icons"></i></span>
					<a>Submit</a>
				</div>
			</div>
...
<center>
<a href="doc/Your report 2020.pdf" target="_blank" class="button11" style="border-radius: 5px;    font-size: 18px;">IOSR Year Report 2021</a>
</center>
<!-- Help List
<h5>Quick Links</h5>
<ul class="help-list">
...
<!-- /Secondary Navigation --> 
        ...
        <div class="col-md-9 col-sm-8 right-panel">
          <div class="box-default3"> 
           ...
           <h6 class="panel-title big"> Query</h6>
</div>
               <div class="panel panel-default">
                 <div class="panel-heading" id="headingTwo" role="tab">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                     <p style="text-align:center; font-size:16px;"><strong>Your Queries are welcome through Mail id <a href="mailto:support@iosrmails.org" target="_blank" class="my">support@iosrmails.org</a><!----
                     <br>
                     or<---></strong></p>
                     <p style="text-align:center; font-size:16px;">or</p>
                    
                     
      <iframe src='query.php' frameborder=''  height="600" width="800" style="border:1px solid;"></iframe>
</div>
      </div>
